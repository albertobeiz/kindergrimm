...
export const Extras = {
  ...
  meta: () => ({
    mark: { label: 'marca', pick: ['none', 'seam', 'scar', 'barcode', 'sutures'] },
    mod: { label: 'mod ocular', pick: ['none', 'cyber', 'patch', 'monocle'] },
    ...
    glasses: { label: 'gafas', bool: true },
    antenna: { label: 'antena', bool: true },
    accidents: { label: 'trazos sueltos', bool: true },
    smudge: { label: 'borrón', bool: true },
    eraser: { label: 'goma', bool: true },
  }),
